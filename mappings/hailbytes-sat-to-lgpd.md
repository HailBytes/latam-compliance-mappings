...
|---|---|---|---|
| **Art. 6 — Principles** | Good faith and accountability in data processing; prevention of harm; non-discrimination | General security culture training; data minimization modules; ethics content | Training completion records demonstrating organizational commitment to data protection principles |
...
| **Art. 47 — Confidentiality** | Persons involved in processing must maintain confidentiality of personal data; controllers must ensure agents/employees comply | SAT modules covering data handling, confidentiality obligations, and insider threat awareness | Signed acknowledgement records; module completion per employee; attestation workflow |
| **Art. 48 — Incident Response** | Controller must notify ANPD and affected data subjects of security incidents within reasonable timeframe | Phishing simulation and incident response training modules prepare employees to recognize and report security events promptly | Tabletop exercise records; incident recognition training completion; mean time-to-report metrics from simulations |
...
| **Art. 37 — Records of Processing** | Controllers must maintain records of processing activities | SAT generates and retains processing activity records for all training and simulation data | Immutable audit logs stored in customer's own cloud account; available for ANPD audit on demand |
