# Acordo de Processamento de Dados — Modelo LGPD

**Versão:** 1.0
**Jurisdição:** Brasil — Lei Geral de Proteção de Dados (Lei 13.709/2018)
...
**CONTROLADOR:**
[EMPRESA CONTROLADORA], pessoa jurídica de direito privado, inscrita no CNPJ sob o nº [CNPJ], com sede na [ENDEREÇO COMPLETO], representada neste ato por [NOME DO REPRESENTANTE LEGAL], [CARGO] ("Controlador")

**E**

**OPERADOR:**
[EMPRESA OPERADORA], pessoa jurídica de direito privado, inscrita no CNPJ sob o nº [CNPJ], com sede na [ENDEREÇO COMPLETO], representada neste ato por [NOME DO REPRESENTANTE LEGAL], [CARGO] ("Operador")
...
**Encarregado (DPO) do Controlador:** [NOME]
**Contato do Encarregado:** [E-MAIL]
**Encarregado (DPO) do Operador:** [NOME]
**Contato do Encarregado:** [E-MAIL]
